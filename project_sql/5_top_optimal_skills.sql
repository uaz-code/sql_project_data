...
WITH skills_demand AS 
    ...
    ---note in Select here columns exist only in CTE so prefix to CTE
...
/* KeY findings
--SQL is the most valuable core skill for Data Analysts, with the highest demand (398 postings) 
